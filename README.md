...
**Read [`INSIGHTS.md`](INSIGHTS.md) first.** It is the honest record of 20 findings and
...
| | |
|---|---|
| [`INSIGHTS.md`](INSIGHTS.md) | what we learned — 20 findings, 7 dead ends, mostly measured |
